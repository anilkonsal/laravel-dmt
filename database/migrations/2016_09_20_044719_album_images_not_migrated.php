...
class AlbumImagesNotMigrated extends Migration
{
    /**
     * Run the migrations.
     *
...
BEGIN
    ...
    read_loop: LOOP
		FETCH AlbumImages into digitalId, mFolder, mRoot,subfolders;
        IF done = 1 THEN
			LEAVE read_loop;
		END IF;
...
EOSP;
    ...
    {
        \DB::unprepared('DROP Procedure if exists `album_images_not_migrated`;');
    }
}
